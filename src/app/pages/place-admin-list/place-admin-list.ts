...
import { CategoryAdmin } from 'src/app/services/categoriesAdmin';
...
@Component({
  selector: 'app-place-admin-list',
  templateUrl: './place-admin-list.html',
  styleUrls: ['./place-admin-list.scss'],
  animations: [
    trigger('staggerIn', [
      transition('* => *', [
...
export class PlaceAdminListPage extends BasePage {
  ...
  public params: any = {};
  public category: CategoryAdmin;
  public skeletonArray: any;
  public places: PlaceAdmin[] = [];
  ...
  constructor(injector: Injector,
              ...
              private placeService: PlaceAdmin) {
    super(injector);
  ...
  async ionViewDidEnter() {
    ...
    if (!this.places.length) {
      ...
      if (typeof this.params.cat === 'string') {
        this.category = new CategoryAdmin;
