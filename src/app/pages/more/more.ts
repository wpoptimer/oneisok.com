...
import { SliderImageAdmin } from 'src/app/services/slider-image-admin';
...
export class MorePage extends BasePage {
  ...
  public slides: SliderImageAdmin[] = [];
  public featuredPlaces: Place[] = [];
  public newPlaces: Place[] = [];
  public places: Place[] = [];
  public nearbyPlaces: Place[] = [];

  public categories: CategoryAdmin[] = [];
  public essentials: Essential[] = [];
  public offers: Offer[] = [];
  ...
  async loadData() {
    ...
    try {
      ...
      this.categories = data.categoriesAdmin || [];
      this.essentials = data.essentials || [];
      this.offers = data.offers || [];
      this.slides = data.sliderImageAdmin || [];
